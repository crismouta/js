...
test('06_modules-1: can import Mathy', () => {
...
test('06_modules-2: can specify what to import, to only retain pieces of the import', () => {
...
test('06_modules-3: can import from my node_modules', () => {
  // import `lodash`
  expect(_).toBeDefined()
})

test('06_modules-4: can import Mathy', () => {
  // Importa el mòdul Mathy i comprova que funciona correctament
  expect(Mathy.add(1, 2)).toBe(3)
})

test('06_modules-5: can specify what to import, to only retain pieces of the import', () => {
  // Importa només les parts necessàries del mòdul Mathy
  expect(add(1, 2)).toBe(3)
})

test('06_modules-6: can import from my node_modules', () => {
